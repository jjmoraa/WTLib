%Blade Builder
function [blade]=bladeBuilderBEMv2_03(inputs,parentFolder,airfoils,filename,numel)
...
affile=sprintf('%s\\Airfoils\\IEA-15-240-RWT_AF%02d_Coords.txt', ...
                 parentFolder,airfoils{k, "name"});
%affile=[parentFolder,'\Airfoils\IEA-15-240-RWT_AF%02d_Coords',convertStringsToChars(airfoils{k,"name"}),'.txt'];
%here is the method
