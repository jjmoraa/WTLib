...
% Open the text file for reading
fid = fopen([parentFolder,'\Inputs\BladeSectionsv4.dat'], 'r');%CHECK!
...
numel=10;
[blade]=bladeBuilderBEMv2_01(inputs,parentFolder,airfoils,[parentFolder,'\Inputs\Excel2ObjectExample.xlsx'],numel);
...
legend('x','y','z','xx','yy','zz','Location','southwest')