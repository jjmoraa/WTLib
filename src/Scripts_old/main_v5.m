...
for a_in=[1 10 20 30 31 32 33]
    for n_in=30:50
        for p_in=5:25
            fprintf('%4.4f %4.4f %4.4f \n',a_in,n_in,p_in)
[inputs]=jamieson(a_in/100,n_in/100,p_in/100,hubRad,3,inputs,parentFolder,airfoils);
...
for j=1:height(inputs) %JJM: Here I would do length(blade.ispan)
    ...
    [a,ap,cp,F,cl,cd,relWind,aoa,r,R]=bem_solver_v3_01(3,9,chord,r,R,hubRad,twist,table1); %Here I would have bem_solver_v3_00 instead. solved
...
%powervector(a_in,n_in,p_in)=totalpwr;
