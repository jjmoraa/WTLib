...
foldername = [parentFolder, '/Results/MDO_submission/', sprintf('%s_%s/', scriptName, currentDate)]; % Create the filename
...
for count=3
    ...
    cmmids,dT,dQ,totalpwr,refmoment,mass,blade,rmids,hubRad,D,R,F,L,Ks,...
    [parentFolder,'\Results\MDO_submission'],'referenceCase');
    
    %Plotting all the reference case plots
    plottingCase(referenceCase,parentFolder,'MDO_submission','referenceCase')
...
%% jamiesons fit
    ...
    saveas(fig,[parentFolder,'/Results/MDO_submission/','RefCase','equivalent fit.jpg'])
...
%% modified reference case for root moment algorithm
    ...
    F_rootmom,L_rootmom,Ks_rootmom]=...
        moment_matching...
    ...
    R_rootmom,F_rootmom,L_rootmom,Ks_rootmom,...
    [parentFolder,'\Results\MDO_submission'],'crefjamiesonsCase_rootmom');
...
%% modified reference case for tip deflection algorithm
    ...
    R_tipdfl,F_tipdfl,L_tipdfl,Ks_tipdfl,...
    [parentFolder,'\Results\MDO_submission'],'crefjamiesonsCase_tipdfl');
...
%% Plotting the comparisson between reobtained reference blades for root moment and tip deflection
    ...
    saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase',...
    ...
    saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','Deflection all references.jpg'])
    %legend('dT','dQ','Location','Southwest')
    ...
    saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','Momentcoeff all references.jpg'])
    %legend('dT','dQ','Location','Southwest')
...
grid_points=JamiesonsBoundGenerator(fitcurve.a,fitcurve.n,fitcurve.p,4,fitcurve.p,6,20);
    ...
    %for n_in=nbounds(1):nbounds(2):nbounds(3) %concave <1 convex
     ...
     %add case to results table
                newRow={a_in,n_in,p_in,a,ap,ocp,oct,ocm,totalpwr/crefjamiesonsCase_rootmom.totalpwr...
                    ...
                    ,jamiesonsCaseMomMatch(index).blade.ispan(end)/crefjamiesonsCase_rootmom.blade.span(end),D(1,end)/crefjamiesonsCase_rootmom.D(1,end),newjammoment/crefmoment_rootmom,mass/crefmass_rootmom};
...
%%            
     ...
     %add case to results table
                newRow={a_in,n_in,p_in,a,ap,ocp,oct,ocm,totalpwr/crefjamiesonsCase_tipdfl.totalpwr...
                    ...
                    ,bladespan/crefjamiesonsCase_tipdfl.blade.span(end),D(1,end)/crefjamiesonsCase_tipdfl.D(1,end),newjammoment/crefmoment_tipdfl,mass/crefmass_tipdfl};
                %D1=[jamiesonsCase(a_in,n_in,p_in).ocp,jamiesonsCase(a_in,n_in,p_in).oct,jamiesonsCase(a_in,n_in,p_in).ocm,jamiesonsCase(a_in,n_in,p_in).totalpwr,jamiesonsCase(a_in,n_in,p_in).blade.span(end),jamiesonsCase(a_in,n_in,p_in).D(3,end)];
                %D2=[referenceCase.ocp,referenceCase.oct,referenceCase.ocm,referenceCase.totalpwr,referenceCase.blade.span(end),referenceCase.D(3,end)];
                %P=[D1;D2];
                %spider_plot(P,'AxesLabels', {'ocp', 'oct', 'ocm', 'totalpwr', 'R' ,'tipdfl'})
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','cpjheatmap_rootmom.jpg'])
fig = plotHeatmapFromTable(powertable_rootmom, 'n','p', 'blade span');
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','bladespanjheatmap_rootmom.jpg'])
fig = plotHeatmapFromTable(powertable_rootmom, 'n','p', 'cpR^2');
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','cpr2heatmap_rootmom.jpg'])
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','tipdflheatmap_rootmom.jpg'])
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','cpjheatmap_tipdfl.jpg'])
fig = plotHeatmapFromTable(mod_powertable_tipdfl, 'n','p', 'blade span');
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','bladespanjheatmap_tipdfl.jpg'])
fig = plotHeatmapFromTable(mod_powertable_tipdfl, 'n','p', 'cpR^2');
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','cpr2heatmap_tipdfl.jpg'])
fig = plotHeatmapFromTable(mod_powertable_tipdfl, 'n','p', 'moment');
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','momentheatmap_tipdfl.jpg'])
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetoCpr2spanmass.jpg'])
fig=Important_plotter(idx,modpowertable,fitcurve.a,fitcurve.n,fitcurve.p);
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetocurvesCpr2spanmass.jpg'])
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetoCpr2spantipdfl.jpg'])
fig=Important_plotter(idx,modpowertable,fitcurve.a,fitcurve.n,fitcurve.p);
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetocurvesCpr2spantipdfl.jpg'])
...
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetoCpr2spanmass_closeup.jpg'])
fig=Important_plotter(idx,modpowertable,fitcurve.a,fitcurve.n,fitcurve.p);
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetocurvesCpr2spanmass_closeup.jpg'])

[fig,modpowertable,paretoX, paretoY, idx, globalidx]=ParetoFront_v3(powertable_rootmom,'cpR^2','tip deflection','mass'); %max, min
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetoCpr2tipdflmass.jpg'])
fig=Important_plotter(idx,modpowertable,fitcurve.a,fitcurve.n,fitcurve.p);
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetocurvesCpr2tipdflmass.jpg'])

[fig,modpowertable,paretoX, paretoY, idx, globalidx]=ParetoFront_v3(mod_powertable_tipdfl,'cpR^2','blade span','mass'); %max, min
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetoCpr2spanmass_tipdfl.jpg'])
fig=Important_plotter(idx,modpowertable,fitcurve.a,fitcurve.n,fitcurve.p);
saveas(fig,[parentFolder,'/Results/MDO_submission/','CRefCase','ParetocurvesCpr2spanmass_tipdfl.jpg'])
